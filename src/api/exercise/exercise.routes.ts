...
router.get('/search/muscle-groups', ExerciseController.searchExercisesByMuscleGroups)
...
router.put('/exercise-id', requireAuth, ExerciseController.updateExerciseByExerciseId)
router.put('/:id', requireAuth, ExerciseController.updateExercise)
router.delete('/exercise-id', requireAuth, ExerciseController.deleteExerciseByExerciseId)
