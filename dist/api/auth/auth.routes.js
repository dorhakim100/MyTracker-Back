...
router.post('/google/connect-url', auth_controller_1.AuthController.getGoogleConnectUrl);
...
router.post('/google/native-exchange', auth_controller_1.AuthController.exchangeNativeGoogleAuth);
