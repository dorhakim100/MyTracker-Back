...
exports.buildBodyFatEstimatePrompt = buildBodyFatEstimatePrompt;
function buildBodyFatEstimatePrompt(weightKg) {
...
- Use status "ok" when you can give a reasonable visual estimate. Provide bodyFatMin, bodyFatMax (percent, 1 decimal), and note (1-3 sentences, plain language).
